function out = get_scale_hw_sample(im, pos, base_target_sz,currentScaleFactor, hw_scaleFactors, scale_window, scale_model_sz)
...
nScales = length(hw_scaleFactors);

for s = 1:nScales
    patch_sz = floor(base_target_sz *currentScaleFactor.*(hw_scaleFactors(:,s)'));
